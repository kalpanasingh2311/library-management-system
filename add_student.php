...
<form action="add_student_submit.php" method="post" enctype="multipart/form-data">
    name:
    <input type="text" name="studentname"  class="form-control"  value="">
     <br>
    enrolment:
    <input type="text" name="enrolment"  class="form-control"  value="">
    <br>
    course:
    ...
    <br>
    Current_sem:
    <input type="text" name="currentsem"   class="form-control" value="">
     <br>
